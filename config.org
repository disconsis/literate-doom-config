...
I think this only happens in =visual-line-mode=
...
** Actual window zoom with https://github.com/emacsorphanage/zoom-window
Without either half-ass zooming or closing other windows

** TODO Make company-org-roam completions actually show up

** TODO Set company-complete-...whatever to C-n instead of RET

** TODO Stop dap-dart loading automatically
